...
Este documento descreve a estrutura hierárquica de categorias do Moodle implementada no sistema, que permite organizar as Unidades Curriculares (UCs) de acordo com a estrutura organizacional do SENAI/SESI.
   ...
   └── Depth 2: Escola (ID 87 = Escola SENAI Vila Canaã)
         └── Depth 3: Curso (ID 6375 = Operador de Computador)
               └── Depth 4: Turma/Evento (ID 6406 = 1003121 - Operador de Computador - 00003/2025)
                     └── UCs (Unidades Curriculares - cursos do Moodle)
```
...
O documento `UcDocument` armazena os dados de cada Unidade Curricular com os seguintes campos de hierarquia:
...
7. **Mapeia a hierarquia completa** para cada UC usando a posição no Path
